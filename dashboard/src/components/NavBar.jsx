        ...
        <>
            ...
            <div className="mt-16 bg-red-300 h-10 flex items-center px-6 shadow" >
                <ul className="flex gap-6">
                    <li className="cursor-pointer hover:text-blue-500" onClick={() => { navigate("/", { replace: true }) }}>Home</li>
                    <li className="cursor-pointer hover:text-blue-500" onClick={() => { navigate("/allUsers") }}>All Users</li>
